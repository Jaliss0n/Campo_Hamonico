...
class CampEm extends StatefulWidget {
  @override
  _CampEmState createState() => _CampEmState();
}

class _CampEmState extends State<CampEm> {
                ...
                children: <Widget>[
                  ...
                  Hero(
                    ...
                    child: GestureDetector(
                      ...
                      child: Image.asset(
                        "images/cF#md.png", /// tenque MUDARRRRRRRRRRRR
                        width: ScreenIcon,
                      ),
                    ),
                  ),
